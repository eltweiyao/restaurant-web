/* eslint-disable */
/* create by xiaochenghua on 2018/12/28 */
/**
...
export default class LocalInput extends Component {
  ...
  render() {
    ...
    const flag =
      !('suffix' in this.props) &&
      !('allowClear' in this.props) &&
      'clearbtn' in this.props &&
      (value || defaultValue);
    return (
      <div style={{ position: 'relative' }}>
        <Input {...localProps} ref={node => (this.clearInput = node)} />
        {flag && (
          <Icon type="close-circle" className={styles.clearIcon} onClick={this.clearValue} />
        )}
      </div>
    );
  }
