...
const list = ({
  ...
  const expandedRowRender = record => {
    ...
    const columns = [
      ...
      { title: "物料用量", dataIndex: "materialCount", key: "materialCount" },
  ...
  const columns = [
    ...
    },
    {
      ...
      render: item => (
        <span>
          <button className="btn-link" onClick={() => onEditRecipeName(item)}>
            修改菜品信息
          </button>
          &nbsp;&nbsp;
          <button className="btn-link" onClick={() => onAddMaterial(item)}>
            添加所用物料
          </button>
          &nbsp;&nbsp;
          <Popconfirm
